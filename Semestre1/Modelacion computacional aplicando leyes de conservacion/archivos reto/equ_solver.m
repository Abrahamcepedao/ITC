...
%c = -5318.5881;
%d = 1885.1121;
fprintf("h(x)=%.15f*sin(0.01x)+%.15f*cos(0.01x)+%.15f*sin(2(0.01)x)+%.15f*cos(2(0.001)x)\n",v1,v2,v3,v4);
disp("Derivada:");
deriv = diff(v1*sin(0.01*x)+v2*cos(0.01*x)+v3*sin(2*(0.01)*x)+v4*cos(2*(0.01)*x));
disp(deriv)
deriv12 = subs(deriv, {x}, 12);
deriv35 = subs(deriv, {x}, 35);
fprintf("h'(x): %.12f", deriv12);
fprintf("h'(x): %.12f", deriv35);